...
public class Logging {
	...
	public static String desktopPath = fsv.getHomeDirectory().toString();
	String folderParentPath = desktopPath + "\\Automation\\Result";  //path for folder of logs
